...
Dies ist damit begründet, dass die Docker-Engine (\ac{Abb.} \ref{figure:layers-docker}) auf den einzelnen Betriebssystemen verschieden aussieht.
\par
